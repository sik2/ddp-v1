    ...
    <div className="bg-white rounded-lg shadow-sm p-4 border border-slate-200/80 flex flex-col sm:flex-row items-center gap-4">
      <div className="w-full relative" ref={dropdownRef}>
        <button
          ...
          className="w-full p-3 border border-slate-200 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition-all duration-300 text-slate-600 bg-white flex justify-between items-center hover:border-yellow-300 shadow-sm"
          type="button"
      ...
      <button
        className="w-full sm:w-auto bg-yellow-400 text-white px-8 py-3 rounded-md font-medium hover:bg-yellow-500 active:bg-yellow-600 transform hover:scale-105 active:scale-95 transition-all duration-200 border border-yellow-400 hover:border-yellow-500 shadow-sm"
        type="button"
      >
        검색
      </button>
